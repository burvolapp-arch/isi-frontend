      ...
      <main className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-16">
        ...
        <div className="mt-12 max-w-3xl space-y-2">
          {FAQ_ITEMS.map((item, i) => (
            <details
              key={i}
              className="group rounded-md border border-border-primary bg-surface-primary transition-[border-color] open:border-border-secondary open:bg-surface-tertiary"
            >
