...
export function KPICard({
  ...
  return (
    <div
      className={`group rounded-md border border-border-primary bg-surface-tertiary px-4 py-3 transition-[border-color,box-shadow] duration-150 hover:border-border-secondary hover:shadow-[0_1px_3px_rgba(0,0,0,0.04)] sm:px-5 sm:py-4 ${
