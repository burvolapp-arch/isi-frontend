...
export function AxisCard({ axis }: AxisCardProps) {
  return (
    <div className="group card-lift rounded-md border border-border-primary bg-surface-primary p-5 transition-[border-color,box-shadow,transform] duration-150 hover:border-border-secondary hover:shadow-[var(--shadow-card-hover)]">
