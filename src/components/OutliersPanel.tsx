      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        {outliers.map((card) => (
          <Link
            ...
            className="group block rounded-md border border-border-primary bg-surface-primary p-4 sm:p-5 transition-[border-color,box-shadow] duration-150 hover:border-border-secondary hover:shadow-[0_2px_8px_rgba(0,0,0,0.04)]"
          >
